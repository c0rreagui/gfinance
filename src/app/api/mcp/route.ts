...
// GET: Endpoint MCP SSE (Server-Sent Events) - O Google Gemini exige text/event-stream com evento "endpoint"
export async function GET(req: Request) {
  ...
  const stream = new ReadableStream({
    start(controller) {
      ...
      // Evento inicial exigido pela especificação MCP SSE transport
