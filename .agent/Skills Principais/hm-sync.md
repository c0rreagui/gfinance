...
3. **Consistência do Cache em Mutations:** Toda mutation no frontend que altere dados refletidos in outras páginas deve invalidar explicitamente os caches envolvidos ou atualizar o estado global de forma reativa e imediata.
