---
description: Visao geral das skills Highermind
---

# highermind-code-skills (v2.1 — Security-First)

Seis modos cognitivos de execucao pro Claude Code, construidos na filosofia Higher Mind. **Seguranca e pre-requisito bloqueante em todas as skills.**

## Skills disponiveis

- `/hm-init` — Comecar um novo projeto com as melhores ferramentas, estrutura e seguranca desde o commit zero
- `/hm-engineer` — Validar codigo em todas as camadas (seguranca primeiro, depois arquitetura, performance, custo, qualidade)
...
- `/hm-sync` — Garantir sincronidade dos dados com a plataforma e realizar auditorias com autoavaliação de consistência
